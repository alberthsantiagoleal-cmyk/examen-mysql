...
(100126789, 'Carlos',   'Ramirez',  'Cardiologia',    'Titular',   'Lunes',     '08:00:00', '14:00:00'),
(100234567, 'Maria',    'Gomez',    'Pediatria',      'Titular',   'Martes',    '07:00:00', '13:00:00'),
(100345678, 'Andres',   'Torres',   'Dermatologia',   'Interino',  'Miercoles', '09:00:00', '15:00:00'),
(100456789, 'Laura',    'Perez',    'Ginecologia',    'Sustituto', 'Jueves',    '08:00:00', '12:00:00'),
(100567890, 'Jorge',    'Martinez', 'Ortopedia',      'Titular',   'Viernes',   '10:00:00', '16:00:00'),
...
(200112233, 'Diana',    'Suarez',   'ATS',                    'Manana'),
(200223344, 'Felipe',   'Castro',   'Celador',                'Tarde'),
(200334455, 'Natalia',  'Ortiz',    'Auxiliar de enfermeria', 'Manana'),
(200445566, 'Ricardo',  'Mendez',   'ATS',                    'Noche'),
(200556677, 'Camila',   'Vargas',   'Auxiliar de enfermeria', 'Manana');
...
(200112233, '2026-09-01', '2026-09-15', 'Disfrutada'),
(200223344, '2026-10-01', '2026-10-05', 'Planificada'),
(200445566, '2026-08-15', '2026-08-28', 'Disfrutada');
